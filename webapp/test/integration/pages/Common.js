sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/cs/test/test2/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.cs.test.test2.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/cs/test/test2/localService/mockserver"], function (mockserver) {
