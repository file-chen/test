...
sap.ui.require([
	...
	sap.ui.require([
		"com/cs/test/test2/test/integration/NavigationJourneyPhone",
		"com/cs/test/test2/test/integration/NotFoundJourneyPhone",
		"com/cs/test/test2/test/integration/BusyJourneyPhone"
	], function () {
		QUnit.start();
	});
});