sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("com.cs.test.test2.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias com.cs.test.test2.controller.ListSelector
			 */
			 ...
			 * @return {com.cs.test.test2.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
